-- =============================================
-- MIGRATION: Create Query Analytics Functions
-- Description: PostgreSQL RPC functions for efficient query analytics
-- Date: 2025-12-20
-- Purpose: Aggregate web_search_query data in PostgreSQL instead of JavaScript
-- =============================================

-- =============================================
-- FUNCTION 1: get_query_overview
-- Returns: total queries, unique queries, top platform, avg query length
-- =============================================
...
-- Returns: Top N queries with their counts for word cloud visualization
-- =============================================
...
-- Returns: Top 10 queries per platform (OpenAI and Gemini)
-- =============================================
...
-- Returns: Query categorization by intent patterns
-- =============================================
...
-- Returns: Top queries with metadata (platforms, domains)
-- =============================================
...
-- Returns: Rising, declining, new query counts + momentum score
-- =============================================
...
-- Returns: Daily query counts for velocity chart
-- =============================================
...
-- Returns: Queries with positive growth rate
-- =============================================
...
-- Returns: Queries with negative growth rate
-- =============================================
...
-- Returns: Query volume and growth for momentum matrix
-- =============================================
...
-- Returns: New queries that appeared in current period
-- =============================================
...
-- Returns: Query-Domain correlation matrix data
-- =============================================
...
COMMENT ON FUNCTION get_query_overview IS 'Returns overview metrics: total queries, unique queries, top platform, avg query length';
COMMENT ON FUNCTION get_query_word_cloud IS 'Returns top N queries with counts for word cloud visualization';
COMMENT ON FUNCTION get_query_platform_distribution IS 'Returns top 10 queries per platform (OpenAI and Gemini)';
COMMENT ON FUNCTION get_query_intent_breakdown IS 'Returns query categorization by intent patterns';
COMMENT ON FUNCTION get_top_queries IS 'Returns top queries with metadata (platforms, domains)';
COMMENT ON FUNCTION get_trend_metrics IS 'Returns rising, declining, new query counts + momentum score';
COMMENT ON FUNCTION get_query_velocity IS 'Returns daily query counts for velocity chart';
COMMENT ON FUNCTION get_rising_queries IS 'Returns queries with positive growth rate';
COMMENT ON FUNCTION get_declining_queries IS 'Returns queries with negative growth rate';
