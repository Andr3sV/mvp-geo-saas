-- ============================================
-- FUNCTION: get_daily_mentions_evolution (Updated with topic filter)
-- ============================================
-- Aggregates mentions by day for Share of Voice evolution chart
-- Now includes topic_id filter for more granular analysis
-- ============================================

-- Drop the old function first
DROP FUNCTION IF EXISTS get_daily_mentions_evolution(UUID, UUID, TIMESTAMPTZ, TIMESTAMPTZ, TEXT, TEXT);
...
-- Add comment
COMMENT ON FUNCTION get_daily_mentions_evolution IS 'Returns daily aggregated mentions count for brand and competitor, with optional topic filter, optimized for large datasets';
