-- =============================================
-- FUNCTION: Count Distinct Citation Pages
-- Description: Efficiently counts DISTINCT ai_response_id 
-- with proper filtering for platform, region, and dates
-- =============================================
...
GRANT EXECUTE ON FUNCTION count_distinct_citation_pages(UUID, TIMESTAMPTZ, TIMESTAMPTZ, TEXT, TEXT) TO authenticated;

-- Add comment
COMMENT ON FUNCTION count_distinct_citation_pages IS 'Counts distinct AI response IDs that have citations with URLs, with optional filtering by date range, platform, and region';
